...
#pragma warning restore CA1063
        ...
        {
            get { return _poolPolicy; }
        }

        /// <summary>
        /// Returns a boolean indicating if {T} is disposable.
        /// </summary>
        protected bool IsPooledTypeDisposable
        {
            get { return _isPooledTypeDisposable; }
        }
        ...
        {
            // Check if value has already been returned
            if (Contains(value))
                return false;
            ...
            // Pool is full, dispose this element
            SafeDispose(value);
